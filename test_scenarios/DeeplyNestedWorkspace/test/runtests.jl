...
# JSON is a dependency of the workspace root, and should be available:
...
# CSV is a dependency of the workspace root test project, and should be available in this package:
